...
assembly="$HOME/All_De_Novo/Flye/Meta"
##outputs
alignOutput="$HOME/All_Reads_Vs_Assembly/Flye/Meta"
blastOutput="$HOME/All_BLAST/Flye/Meta"
blobOutput="$HOME/All_BlobTools/Flye/Meta"

THREADS="16"
data="$HOME/InputFiles/Flye_AssembledIsolates.txt"
...
do
    ...
    samtools view -bS ${alignOutput}/${iso}_readsVsAssem.sam > ${alignOutput}/${iso}_readsVsAssem.bam
    # sort the bam file
    samtools sort -o ${alignOutput}/${iso}_readsVsAssem_sorted.bam ${alignOutput}/${iso}_readsVsAssem.bam
    # clean up
