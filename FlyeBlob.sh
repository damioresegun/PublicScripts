...
data="$HOME/InputFiles/All_DeN_Flye_AssembledIsolates.txt"
assembly="$HOME/All_De_Novo/All_DeNoVo/Flye"
##outputs
alignOutput="$HOME/All_Reads_Vs_Assembly/All_DeNovo/Flye"
blastOutput="$HOME/All_BLAST/All_DeNovo/Flye"
blobOutput="$HOME/All_BlobTools/All_DeNovo/Flye"
...
do
    ...
    samtools view --threads $THREADS -bS ${alignOutput}/${iso}_readsVsAssem.sam > ${alignOutput}/${iso}_readsVsAssem.bam
    # sort the bam file
    samtools sort --threads $THREADS -o ${alignOutput}/${iso}_readsVsAssem_sorted.bam ${alignOutput}/${iso}_readsVsAssem.bam
    # clean up
